...
if __name__ == '__main__':
    ...
    setup(
        ...
        ext_modules=[
            ...
            make_cuda_ext(
                name='quick_convex_ext',
                module='mmdet.ops.quick_convex_ext',
                sources=[
                    'src/quick_convex_sort_ext.cpp',
                    'src/quick_convex_sort_cpu.cpp'
                ],
                sources_cuda=['src/quick_convex_sort_cuda.cu']),
            make_cuda_ext(
                name='nms_ext',
            ...
            make_cuda_ext(
                ...
                sources=[
                    'src/nms_rotated_cpu.cpp', "src/poly_nms_cpu.cpp",
